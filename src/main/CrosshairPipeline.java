 ...
 * @author GRIP
 */
public class CrosshairPipeline {
	...
	public void process(Mat source0) {
		...
		Point cvCrosshairVBottomPt1 = new Point(StreamViewer.streamPixelWidth / 2, StreamViewer.streamPixelHeight * 0.625);
		Point cvCrosshairVBottomPt2 = new Point(StreamViewer.streamPixelWidth / 2, StreamViewer.streamPixelHeight);
		Scalar cvCrosshairVBottomColor = new Scalar(0.0, 0.0, 0.0, 0.0);
		double cvCrosshairVBottomThickness = 2.0;
		int cvCrosshairVBottomLinetype = Imgproc.LINE_4;
		...
		Point cvCrosshairVMiddlePt1 = new Point(StreamViewer.streamPixelWidth / 2, -1);
		Point cvCrosshairVMiddlePt2 = new Point(StreamViewer.streamPixelWidth / 2, StreamViewer.streamPixelHeight);
		Scalar cvCrosshairVMiddleColor = new Scalar(0.0, 0.0, 0.0, 0.0);
		double cvCrosshairVMiddleThickness = 1.0;
		int cvCrosshairVMiddleLinetype = Imgproc.LINE_4;
		...
		Point cvCrosshairVTopPt1 = new Point(StreamViewer.streamPixelWidth / 2, -1);
		Point cvCrosshairVTopPt2 = new Point(StreamViewer.streamPixelWidth / 2, StreamViewer.streamPixelHeight * 0.375);
		Scalar cvCrosshairVTopColor = new Scalar(0.0, 0.0, 0.0, 0.0);
		double cvCrosshairVTopThickness = 2.0;
		int cvCrosshairVTopLinetype = Imgproc.LINE_4;
		...
		Point cvCrosshairHPt1 = new Point(StreamViewer.streamPixelWidth * 0.45, StreamViewer.streamPixelHeight / 2);
		Point cvCrosshairHPt2 = new Point(StreamViewer.streamPixelWidth * 0.55, StreamViewer.streamPixelHeight / 2);
		Scalar cvCrosshairHColor = new Scalar(0.0, 0.0, 0.0, 0.0);
		double cvCrosshairHThickness = 1.0;
		int cvCrosshairHLinetype = Imgproc.LINE_4;
